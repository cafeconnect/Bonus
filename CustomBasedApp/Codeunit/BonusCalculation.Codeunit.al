codeunit 60100 "MNB Bonus Calculation"
{
    ...
    local procedure FindBonusForAllItems(var MNBBonusHeader: Record "MNB BonusHeader"; var SalesInvLine: Record "Sales Invoice Line")
    var
    ...
    local procedure FindBonusForOneItem(var MNBBonusHeader: Record "MNB BonusHeader"; var SalesInvLine: Record "Sales Invoice Line");
    var
        MNBBonusLine: Record "MNB Bonus Line";
    begin
        MNBBonusLine.SetRange("Document No.", MNBBonusHeader."No.");
